...
# seed of shRNA = nt 2 to 6
# seed-matches as defined in fig 1A of PMID: 17612493
# 8mer = t + seed + 1 extra nucleotide
# the t at the beginning of the seeds gets reverse complemented in the next step as if it is the A1 "microRNA" position
seed_CTRL <- "tttactct"
seed_2B1 <- "ttatactt"
seed_2B4 <- "tagactag"
...
# remove the respective gene from the list - ie when searching for matches of 2B1, remove EIF2B1 from gene list
...
merged_TE_CDS_seed_matches %>% 
  ...
  mytheme +
  scale_color_viridis(discrete = TRUE, name = "sh2B1 8mer\nMatches in CDS", direction = -1,
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B1_TE_8mer_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B1_RPF_8mer_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B1_tots_8mer_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
merged_TE_CDS_seed_matches %>%
  ...
  stat_ecdf(linewidth = 1) +
  mytheme +
  scale_color_viridis(discrete = TRUE, name = "sh2B4 8mer\nMatches in CDS", direction = -1,
                      labels = merged_TE_CDS_seed_matches %>%
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B4_TE_8mer_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B4_RPF_8mer_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B4_tots_8mer_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
merged_TE_CDS_seed_matches %>%
  ...
  stat_ecdf(linewidth = 1) +
  mytheme +
  scale_color_viridis(discrete = TRUE, name = "shCTRL 8mer\nMatches in CDS", direction = -1,
                      labels = merged_TE_CDS_seed_matches %>%
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B1_TE_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B1_RPF_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B1_tots_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B4_TE_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B4_RPF_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B4_tots_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B1_TE_8mer_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B1_RPF_8mer_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B1_tots_8mer_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B4_TE_8mer_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B4_RPF_8mer_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B4_tots_8mer_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B1_TE_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B1_RPF_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B1_tots_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B4_TE_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B4_RPF_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B4_tots_8mer.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
write_csv(merged_TE_all_seed_matches, file = file.path(tables_dir, "shRNA_seed_match_sequence_matches_8mer.csv"))
