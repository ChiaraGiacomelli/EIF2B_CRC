...
# 7mer-A1 = t + canonical seed (nt 2 to 6)
# the t at the beginning of the seeds gets reverse complemented in the next step as if it is the A1 position of a 7mer-A1 binding site
seed_CTRL <- "tttactc"
seed_2B1 <- "ttatact"
seed_2B4 <- "tagacta"
...
merged_TE_CDS_seed_matches %>% 
  ...
  mytheme +
  scale_color_viridis(discrete = TRUE, name = "sh2B1 7mer-A1\nMatches in CDS", direction = -1,
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B1_TE_7mer_A1_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B1_RPF_7mer_A1_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B1_tots_7mer_A1_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
merged_TE_CDS_seed_matches %>% 
  ...
  stat_ecdf(linewidth = 1) +
  mytheme +
  scale_color_viridis(discrete = TRUE, name = "sh2B4 7mer-A1\nMatches in CDS", direction = -1,
                      labels = merged_TE_CDS_seed_matches %>%
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B4_TE_7mer_A1_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B4_RPF_7mer_A1_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_2B4_tots_7mer_A1_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
merged_TE_CDS_seed_matches %>% 
  ...
  stat_ecdf(linewidth = 1) +
  mytheme +
  scale_color_viridis(discrete = TRUE, name = "shCTRL 7mer-A1\nMatches in CDS", direction = -1,
                      labels = merged_TE_CDS_seed_matches %>%
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B1_TE_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B1_RPF_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B1_tots_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B4_TE_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B4_RPF_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_CDS_seed_matches_CTRLin2B4_tots_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B1_TE_7mer_A1_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B1_RPF_7mer_A1_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B1_tots_7mer_A1_wo_2B1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B4_TE_7mer_A1_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B4_RPF_7mer_A1_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_2B4_tots_7mer_A1_wo_2B4.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B1_TE_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B1_RPF_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B1_tots_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B4_TE_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B4_RPF_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
pdf(file = paste0(plot_dir, "seed_matches/", "ECDF_UTR3_seed_matches_CTRLin2B4_tots_7mer_A1.pdf"), width = 8, height = 6)
print(plot)
dev.off()
...
write_csv(merged_TE_all_seed_matches, file = file.path(tables_dir, "shRNA_seed_match_sequence_matches_7mer_A1.csv"))
